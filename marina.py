...
while True:
    ...
    try:
        ...
        if line[0] == 'set':
            ...
            print("\nReal Hackers don't need help, get out!...  This said Weidsom XD.., but how to become one without knowledge?! (he even did not typed commands here -_-) ")
            print("\nset workmode passive/low/high/intrusive")
            print("\nset host xxx")
            print("\nscan for scan host")
            print("\nshow for see what MARINA found out!")
            print("\x1B[31mInstagram: matej_sochan")
